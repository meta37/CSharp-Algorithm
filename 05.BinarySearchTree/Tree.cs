...
namespace _05.BinarySearchTree
{
    internal class Tree
    {
        ...
        public class TreeNode<T> // 트리의 갯수가 일정하지 않아서 관리가 어려움
        {
            public T item;
        ...
        // 그러므로, 특별한 이유가 없는 이상은 이진 트리로 구현하는 것이 일반적 // 구글 정보처럼 아무리 자료가 많아도 금방 구현함
        ...
        // 중위순회(In-Order)   : 왼쪽, 노드, 오른쪽 // 정렬을 보장해줌
        // 후위순회(Post-Order) : 왼쪽, 오른쪽, 노드 // ex) 폴더 같은 것 삭제할때 , 사칙연산
        //
        //        A
        //    ┌───┴───┐
        //    B       C
